# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 12:02:11 2019
https://codeforces.com/group/DIbior3HqT/contest/256327/problem/A
@author: Karapetian
Близнецы
...
"""
input1 = int(input())
input2 = sorted([int(i) for i in input().split()], reverse=True)
res = 0
q = 0
for i in input2:
    if res > sum(input2[q:]):
